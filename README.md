...
`pvc-autoresizer` can patch Custom Resources instead of directly modifying PVCs. This is useful when PVCs are managed by Kubernetes operators (RabbitMQ, CloudNativePG, DragonflyDB, etc.) that treat direct PVC modifications as configuration drift.
